...
class App extends Component {
  ...
  getData = () => {
    ...
    axios({
      ...
      headers: {
        ...
        "x-rapidapi-key": "c6d1036267msh02c0bcded79f108p18b673jsn54c24e2dc091",
        useQueryString: true,
      },
    })
      .then((response) => {
  ...
  render() {
    return (
      <div>
        <nav className="navbar navbar-light fixed-top bg-light flex-md-nowrap p-0 shadow text-monospace text-white">
          <a
